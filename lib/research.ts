...
export type ResearchRecord = { id: string; study_id: string; kind: "fact" | "question" | "review" | "source" | "action" | "analysis" | "challenge" | "product" | "traffic" | "audit" | "brief" | "assistant" | "classification" | "view" | "alert" | "coverage" | "assignment" | "review_task"; payload: Json; created_at: string; updated_at: string };
